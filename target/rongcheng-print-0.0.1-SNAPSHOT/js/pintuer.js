...
/*批量打印面单/批量打印发货单弹出框*/
	...
	var set_to_play_box=$(".set_to_play_box");
	var set_to_play_yes=$(".set_to_play_yes");
	var set_to_play_no=$(".set_to_play_no");
	pl_shipments_btn.click(function(){
		set_to_play_box.css("display","block");
	})
	set_to_play_no.click(function(){
		set_to_play_box.css("display","none");
	})
	set_to_play_yes.click(function(){

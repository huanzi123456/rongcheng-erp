...
public class WzyItemInfo implements Serializable{
	/**
     * 
     */
    private static final long serialVersionUID = 3576932946264822339L;
    /**
     * 
     */
    ...
    public WzyItemInfo(BigInteger id, String erpItemNum, String name, String shortName, BigInteger platformId,
            ...
            String spec, String image2, String image3, String image4, String image5, String image6, String unit,
            BigDecimal length, BigDecimal width, BigDecimal height, BigDecimal weight, String batchCode,
            Timestamp expireDate, String styleCode, String reserved2, String reserved3, BigInteger itemId,
            String insertCategory, String deleteCategory) {
        super();
        this.id = id;
    ...
    public String toString() {
        return "WzyItemInfo [id=" + id + ", erpItemNum=" + erpItemNum + ", name=" + name + ", shortName=" + shortName
                ...
                + ", reserved2=" + reserved2 + ", reserved3=" + reserved3 + ", itemId=" + itemId + ", insertCategory="
                + insertCategory + ", deleteCategory=" + deleteCategory + "]";
    }

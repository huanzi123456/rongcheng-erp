...
public class PlatformErpLink implements Serializable{
    ...
    private Boolean authorized;  //18.该记录是否被授权
    ...
    public PlatformErpLink(BigInteger id, BigInteger itemId, BigInteger platformId, BigInteger shopId,
                           ...
                           Integer autoSynchron, Integer autoOnsale, Integer synchronException, Integer availableStock,
                           Integer allocationRatio, Integer remnantStock, String reserved1, String note,
                           BigInteger ownerId, BigInteger operatorId, Boolean authorized, Timestamp gmtCreate,

...
public class OrderInfo implements Serializable{
    ...
    //有参数的构造器
	public OrderInfo(BigInteger id, String erpOrderNum, BigInteger platformOrderId, BigInteger platformId, BigInteger shopId, Boolean onlineOrder, BigInteger platformBuyerId, BigInteger carrierId, Boolean electronicWaybill, BigInteger trackingNum, String buyerWord, String sellerWord, Timestamp orderCreate, Timestamp orderPay, Timestamp orderDownload, Timestamp orderEdit, Timestamp orderUpload, Timestamp orderMerge, Timestamp orderSplit, Timestamp orderCheck, Timestamp expressSheetPrint, Timestamp saleBillPrint, Timestamp orderOutbound, Timestamp orderInspect, Timestamp orderDeparture, Timestamp refundApply, Timestamp orderLocked, Timestamp orderClosed, Timestamp orderCompleted, Integer orderStatus,
			Integer refundClose, Boolean orderHold, BigDecimal shippingFee, Boolean postagePrepaid, Boolean orderCod, Boolean orderSpecial, String lotCode, Integer invoiceType, String invoiceTitle, BigInteger taxpayerId, String invoiceDetail, Integer orderFeedbackCode, String reserved1, String reserved2, String note, String orderSecretKey, BigInteger ownerId, BigInteger operatorId, Boolean authorized, Timestamp gmtCreate, Timestamp gmtModified, Double orderValue) {
		super();
		this.id = id;
	...
	public String toString() {
		return "OrderInfo [id=" + id + ", erpOrderNum=" + erpOrderNum + ", platformOrderId=" + platformOrderId + ", platformId=" + platformId + ", shopId=" + shopId + ", onlineOrder=" + onlineOrder + ", platformBuyerId=" + platformBuyerId + ", carrierId=" + carrierId + ", electronicWaybill=" + electronicWaybill + ", trackingNum=" + trackingNum + ", buyerWord=" + buyerWord + ", sellerWord=" + sellerWord + ", orderCreate=" + orderCreate + ", orderPay=" + orderPay + ", orderDownload=" + orderDownload + ", orderEdit=" + orderEdit + ", orderUpload=" + orderUpload + ", orderMerge=" + orderMerge + ", orderSplit=" + orderSplit + ", orderCheck=" + orderCheck + ", expressSheetPrint=" + expressSheetPrint
				+ ", saleBillPrint=" + saleBillPrint + ", orderOutbound=" + orderOutbound + ", orderInspect=" + orderInspect + ", orderDeparture=" + orderDeparture + ", refundApply=" + refundApply + ", orderLocked=" + orderLocked + ", orderClosed=" + orderClosed + ", orderCompleted=" + orderCompleted + ", orderStatus=" + orderStatus + ", refundClose=" + refundClose + ", orderHold=" + orderHold + ", shippingFee=" + shippingFee + ", postagePrepaid=" + postagePrepaid + ", orderCod=" + orderCod + ", orderSpecial=" + orderSpecial + ", lotCode=" + lotCode + ", invoiceType=" + invoiceType + ", invoiceTitle=" + invoiceTitle + ", taxpayerId=" + taxpayerId + ", invoiceDetail=" + invoiceDetail + ", orderFeedbackCode="
				+ orderFeedbackCode + ", reserved1=" + reserved1 + ", reserved2=" + reserved2 + ", note=" + note + ", orderSecretKey=" + orderSecretKey + ", ownerId=" + ownerId + ", operatorId=" + operatorId + ", authorized=" + authorized + ", gmtCreate=" + gmtCreate + ", gmtModified=" + gmtModified + ", orderValue=" + orderValue + "]";
	}    
}
